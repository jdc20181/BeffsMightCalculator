...
var pack =   myForm.elements["packs"].value = parseInt(myForm.elements["packs"].value)
  ...
  myForm.elements["mT1_Ft" ].value = parseInt(myForm.elements["T1_Ft" ].value) * T1 * pack
  myForm.elements["mT1_Rng"].value = parseInt(myForm.elements["T1_Rng"].value) * T1* pack
  myForm.elements["mT2_Mnt"].value = parseInt(myForm.elements["T2_Mnt"].value) * T2* pack
  myForm.elements["mT2_Ft" ].value = parseInt(myForm.elements["T2_Ft" ].value) * T2* pack
  myForm.elements["mT2_Rng"].value = parseInt(myForm.elements["T2_Rng"].value) * T2* pack
  myForm.elements["mT3_Mnt"].value = parseInt(myForm.elements["T3_Mnt"].value) * T3* pack
  myForm.elements["mT3_Ft" ].value = parseInt(myForm.elements["T3_Ft" ].value) * T3* pack
  myForm.elements["mT3_Rng"].value = parseInt(myForm.elements["T3_Rng"].value) * T3* pack
 
  myForm.elements["mT4_Mnt"].value = parseInt(myForm.elements["T4_Mnt"].value) * T4* pack
  myForm.elements["mT4_Ft" ].value = parseInt(myForm.elements["T4_Ft" ].value) * T4* pack
  myForm.elements["mT4_Rng"].value = parseInt(myForm.elements["T4_Rng"].value) * T4* pack
  myForm.elements["mT5_Mnt"].value = parseInt(myForm.elements["T5_Mnt"].value) * T5* pack
  myForm.elements["mT5_Ft" ].value = parseInt(myForm.elements["T5_Ft" ].value) * T5* pack
  myForm.elements["mT5_Rng"].value = parseInt(myForm.elements["T5_Rng"].value) * T5* pack
  myForm.elements["mT6_Mnt"].value = parseInt(myForm.elements["T6_Mnt"].value) * T6* pack
  myForm.elements["mT6_Ft" ].value = parseInt(myForm.elements["T6_Ft" ].value) * T6* pack
  myForm.elements["mT6_Rng"].value = parseInt(myForm.elements["T6_Rng"].value) * T6* pack
  myForm.elements["mT6_Rng2"].value = parseInt(myForm.elements["T6_Rng2"].value) * T6* pack
  myForm.elements["mT6_Rng3"].value = parseInt(myForm.elements["T6_Rng3"].value) * T6* pack
  myForm.elements["mT7_Mnt"].value = parseInt(myForm.elements["T7_Mnt"].value) * T7* pack
  myForm.elements["mT7_Ft" ].value = parseInt(myForm.elements["T7_Ft" ].value) * T7* pack
  myForm.elements["mT8_Rng"].value = parseInt(myForm.elements["T8_Rng"].value) * T8* pack
  ...
  myForm.elements["mW1_A"  ].value = parseInt(myForm.elements["W1_A"  ].value) * W1* pack
  myForm.elements["mW1_B"  ].value = parseInt(myForm.elements["W1_B"  ].value) * W1* pack
  myForm.elements["mW1_C"  ].value = parseInt(myForm.elements["W1_C"  ].value) * W1* pack
  myForm.elements["mW2_A"  ].value = parseInt(myForm.elements["W2_A"  ].value) * W2* pack
  myForm.elements["mW2_B"  ].value = parseInt(myForm.elements["W2_B"  ].value) * W2* pack
  myForm.elements["mW2_C"  ].value = parseInt(myForm.elements["W2_C"  ].value) * W2* pack
  myForm.elements["mW3_A"  ].value = parseInt(myForm.elements["W3_A"  ].value) * W3* pack
  myForm.elements["mW3_B"  ].value = parseInt(myForm.elements["W3_B"  ].value) * W3* pack
  myForm.elements["mW3_C"  ].value = parseInt(myForm.elements["W3_C"  ].value) * W3* pack
